...
class fsfml
{
	public:
		...
		//String paths
		//Activities
		std::string imageDir = "./assets/launcher/";
		std::string alchemy = imageDir + "alchemy.png";
		std::string arena = imageDir + "arena.png";
		std::string assistant = imageDir + "assistant.png";
		std::string banquet = imageDir + "banquet.png";
		std::string garden= imageDir + "garden.png";
		std::string heirloom = imageDir + "heirloom.png";
		std::string mail = imageDir + "mail.png";
		std::string packs = imageDir + "packs.png";
		std::string perks = imageDir + "perks.png";
		std::string ranking = imageDir + "ranking.png";
		std::string worldrift = imageDir + "worldrift.png";
		//Activities
